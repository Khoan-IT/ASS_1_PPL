# Generated from d:\HK202\PPL\Assignment_1\assignment1\assignment1\initial\src\main\csel\parser\CSEL.g4 by ANTLR 4.8
# encoding: utf-8
from antlr4 import *
...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\7(\2\2\u0163\u0167\7\t\2\2\u0164\u0168\7\26\2\2\u0165")
        buf.write("\u0168\5D#\2\u0166\u0168\5v<\2\u0167\u0164\3\2\2\2\u0167")
    ...
    def call(self):
        ...
        try:
            ...
            if token in [CSELParser.VAR_IDENTIFIERS]:
                ...
                self.call()
                pass
            elif token in [CSELParser.STR2NUM, CSELParser.NUM2STR, CSELParser.STR2BOOL, CSELParser.BOOL2STR, CSELParser.PRINT, CSELParser.PRINTLN, CSELParser.READ]:
                self.state = 356
                self.built_in_func()
                pass
            else:
