...
class LexerSuite(unittest.TestCase):
    ...
    def test_id_42(self):
        self.assertTrue(TestLexer.checkLexeme(""" khoanne12NNa_Bena___0_123 ""","""khoanne12NNa_Bena___0_123,<EOF>""",142))
    
    def test_kw(self):
        self.assertTrue(TestLexer.checkLexeme(""" While For Continue Break ""","""While,For,Continue,Break,<EOF>""",143))
    ...
    def test_string_85(self):
        self.assertTrue(TestLexer.checkLexeme(""" "He asked me: 'Where is John?'"" ""","""Illegal Escape In String: He asked me: 'W""",185))
    ...
    def test_string_92(self):
        self.assertTrue(TestLexer.checkLexeme(""" "Dai. Hoc. Bach' Khoa" """, """Illegal Escape In String: Dai. Hoc. Bach' """,192))
    
    def test_string_93(self):
        self.assertTrue(TestLexer.checkLexeme(""" "Thanh Pho'" Ho_ Chi???Minh" """, """Thanh Pho'" Ho_ Chi???Minh,<EOF>""",193))    
    
    def test_string_94(self):
        self.assertTrue(TestLexer.checkLexeme(""" "Really \\t DON\'T know" """, """Illegal Escape In String: Really \\t DON\'T""",194))
